            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12">
                    <div class="content-style3 border-radius-6 padding-eleven bg-white tz-background-color">
                            ...
                            <tbody>
                                ...
                                @forelse($urls as $index => $url)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $url->url }}</td>
                                        <td>{{ $url->hits }}</td>
                                        <td>{{date('d-m-Y h:i a', strtotime(strip_tags($url->created_at)))}}</td>
                                        <td width="200">

                                            <a href="{{ route('boarded.url.show', $url->id) }}" class = "btn btn-sm btn-success">
                                                <i class="fa fa-eye"></i>
                                            </a>
                        ...
                        {{ $urls->appends(request()->except('page'))->links('pagination::bootstrap-4') }}
