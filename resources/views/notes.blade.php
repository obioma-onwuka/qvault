                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="no-padding-top no-padding-bottom xs-no-padding">
                        ...
                        @auth
                            ...
                            <h5 class="alt-font text-dark-gray display-block tz-text text-capitalize">Your Note Is Secure with Email Authentication!</h5>

                            <p style = "margin-top:5px; font-size: 15px">
                                This means, whoever that wants to view this note will be required to provide a 6 digit code sent to the registered email.
